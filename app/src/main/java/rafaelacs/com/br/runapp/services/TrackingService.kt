package rafaelacs.com.br.runapp.services
...
import rafaelacs.com.br.runapp.other.Constants.FASTEST_LOCATION_INTERVAL
import rafaelacs.com.br.runapp.other.Constants.LOCATION_UPDATE_INTERVAL
import rafaelacs.com.br.runapp.other.Constants.NOTIFICATION_CHANNEL_ID
import rafaelacs.com.br.runapp.other.Constants.NOTIFICATION_CHANNEL_NAME
import rafaelacs.com.br.runapp.other.Constants.NOTIFICATION_ID
import rafaelacs.com.br.runapp.other.Constants.TIMER_UPDATE_INTERVAL
...
class TrackingService : LifecycleService() {
    ...
    override fun onStartCommand(intent: Intent, flags: Int, startId: Int): Int {
        ...
        return intent.let { super.onStartCommand(it, flags, startId) }
    }

    private var isTimerEnabled = false
    private var lapTime = 0L             //time since it started the timer
